...
CEX_SYMBOL_LIMITS = {
    # Bitfinex отдавал 54 отказа из 79 пар: его квота не выдерживает
    # даже умеренного параллелизма. Меньше пар — меньше отказов и
    # меньше времени, потраченного впустую.
    "bitfinex": 50,
}
